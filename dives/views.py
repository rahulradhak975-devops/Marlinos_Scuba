...
INSTRUCTORS = [
    {"name": "Jayakrishnan", "role": "Instructor", "bio": "Jayakrishnan creates clear, supportive learning experiences that help every diver build confidence, develop strong skills, and enjoy the water safely.", "specialties": "Open Water · Skill Development · Dive Safety", "image_url": "/static/dives/Jayakrishnan.jpg"},
    {"name": "Salman Ul Fariz", "role": "Dive Master", "bio": "Salman Ul Fariz leads calm, well-planned dives, supporting every diver with clear briefings, thoughtful guidance, and a strong focus on safety.", "specialties": "Dive Briefings · Safety Support · Reef Tours", "image_url": "/static/dives/Salman.jpg"},
